...
<body>
        ...
        <header>
            <nav class="navbar">
                <a href="index.html" class="logo">
                    ...
                    <li><a href="projAboutus.html">About Us</a></li>
                    <li class="dropdown">
                        <a href="#">Services</a>
    ...
    <div class="container2">
        <div class="bannercontent">
            <h1 style="color: #f0f0f0; font-family:Poppins, sans-serif;font: size 2rem">Privacy Policy</h1>
            <p style="color: #f0f0f0; font-family: Poppins, sans-serif;">By accessing or using the Platform, you agree to this Policy. If you do<br> not agree to this policy, please do not access or use the platform.</p>
        </div>
    </div>
    </div>
    </div>
        <div class="content">
            ...
            <ul>This Privacy Policy describes how Mahir Company handles your personal information and sets out the rights and obligations that both you and Mahir Company have in relation to your personal information.</ul>
            <ul>By accessing www.MahirCompany.com (the "Site") you accept and agree to the terms and conditions of Mahir Company’s user agreement ("User Agreement"), which includes your consent to, and authorization of, the collection, use and disclosure of your personal information in accordance with this Privacy Policy. Note that under Mahir Company's terms and conditions of use, you must not use the Site if you are under 18 years old.</ul>
        </div>

        <div class="content">
                <h2>1. Collection and Use of Your Personal Information</h2>
            <ul>Mahir Company provides a unique, innovative, community-based online outsourcing service. A failure by you to provide the information requested by us may mean that We are unable to provide some or all of our services to you.</ul>
    <ul>Mahir Company collects personal information when you register with and use Mahir Company. This may include, your name, phone number, and gender.</ul>
    <ul>your user ID and all the material that you booked are not visible to other Mahir Company users.</ul>
    <ul>Mahir Company may use the information collected by it to provide the Mahir Company Services, including (but not limited to):</ul>
    <li>identification and authentication
        <li>to provide, maintain, protect, and improve our services;</li>
    <li>  we are not sharing your data with any third party,</li>
    <li> Users can delete the given details from the account section on the app.</li>
            </div>

        <div class="content">
            <h2>2. Cookies and Anonymous Identifiers</h2>
            <p>
                If you have registered on the Site then your computer or device may store an identifying cookie or anonymous identifier, which can save you time each time you re-visit the Site, by accessing your information when you sign-in to Mahir Company.
            </p>
        </div>

        <div class="content">
            <h2>3. Protecting and Maintaining Personal Information</h2>
            <p>
        ...
        <div class="content">
            ...
            <p>
                we are not sharing your data with any third party.
            </p>
        </div>
        ...
        <div class="content">
            <h2>5. Marketing</h2>
            <ul>
                When you register on the Site you may get various emails and SMS about our latest services, news, and special offers, via your Mahir Company account, personal e-mail address, post or telephone. If you conclude a transaction on the Site, you may also receive Marketing Material from Mahir Company.
            </ul>
            <ul>
                Mahir Company uses Remarketing with Google Analytics to advertise online. Using the Ads Settings in a personal Google account, visitors can opt-out of Google Analytics for Display Advertising and customize Google Display Network ads.
            </ul>
            <ul>
        ...
        <div class="content">
            <h2>6. Administrative Communicationss</h2>
            <p>
                Mahir Company reserves the right to send you administrative and account-related messages that you may not opt-out of. To cease all communications to you from Mahir Company you must close down your Mahir Company account.
            </p>
        </div>

        <div class="content">
            <h2>7. Accessing Personal Information</h2>
            <ul>
                We will allow you, at any time, to access, edit, update and/ or delete the personal information that We hold about you, unless:
            </ul>
            <ul>
                We are legally permitted or required to deny you access to, and/ or to retain, the information; or you make request(s) that are unreasonably repetitive, require Mahir Company to make a disproportionate technical effort (for example, to develop an entirely new system), risk the privacy of others, or would be highly impractical to comply with.
            </ul>
            <ul>
                If you wish to access the personal information We hold about you, or to delete your Mahir Company account, you should contact us here.
            </ul>
            <ul>
            ...
            <li>Users can delete the account from the account section on the app, there is an option to Delete the account.</li>
            <li>For complete account deletion send us a request via email at info@mrmahir.com or contact us at +923096661919.</li>
        </div>


        <div class="content">
            <h2>8. Privacy Concerns</h2>
            <ul>
                If you have concerns about how We handle your personal information or require further information, please email Mahir Company using the contact form provided on the Site. If you make a formal written complaint in relation to our compliance with this Privacy Policy, We will contact you to follow up on that complaint. Other than material that you voluntarily choose to post on the Site (such as Sender postings, bids and comments on other users), the only information about you that We will post publicly is your Mahir Company public profile.
            </ul>
            <ul>
                Mahir Company may, from time to time, modify this Privacy Policy (and update the web page on which it is displayed). Mahir Company will send notification of any such modification to your Mahir Company account and/or your registered email address. You should check that account regularly.
            </ul>
        </div>

        <div class="content">
            <h2>9. Delivery policy</h2>
            <p>
                Mahir's partner arrived at the task location within an hour of booking time.
            </p>
        </div>
        <?php
          include 'footer.php';
