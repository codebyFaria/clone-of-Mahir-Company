...
.content ul {
    list-style-type: disc; /* Sets bullet point style to disc */
    padding-left: 20px; /* Adds some left padding for the list */
}
.content h1{
font-family: Poppins, sans-serif;
margin-left: 10px;
...
@media (min-width: 768px) {
    ...
    <div class="container2">
        <div class="bannercontent">
            <h1 style="color: #f0f0f0; font-family:Poppins, sans-serif;font: size 2rem">Terms & Conditions</h1>
            <p style="color: #f0f0f0; font-family: Poppins, sans-serif ;">All the terms and conditions of Mahir Company are listed below.<br> Please feel free to contact us in case of any confusion.</p>
        </div>
    </div>
    </div>
    </div>
    <main>
    <div class="content">
        <p>All the terms and conditions of Mahir Company are listed below. Please feel free to contact us in case of any confusion.</p>
        <h1>www.mahircompany.com – User Agreement</h1>
        
            <ul>
          <li> Mahir Company is an online platform bridging the gap between service users (customers) and service providers (technicians).</li>
<li>For your convenience, make sure you carefully read all the guidelines given on this terms and conditions page before using Mahir Company.</li>
<li>In these terms and conditions (which are referred to in this document as "these terms"), "Customer" means the customer for whom the Works are to be carried out by Mahir Company's technicians (vendors), and "Mahir Company" means 'Company.' "Contract" means the agreement between the Customer and Mahir Company to carry out the Works.</li>
</ul>
     
    </div>
        <div class="content">
            <h1> Scope of Mahir Company Services</h1>
  
    <ul>
<li>Company offers the Mahir Company Platform to support technicians in finding work and help customers avail their services.</li> 
<li>ompany assigns the verified technicians (according to their availability) for the selected service and shares customer's details with them.</li> 
<li>Customer can change order details or cancel the order if it has not yet been accepted and still has 'received status.</li> 
<li>After the task has been assigned to a technician, his details will be shared with the customer through SMS and Mahir Company's Website and App.</li> 
<li>Upon completing the task, the customer can either pay in cash or through online means, that includes Bank transfer, Easypaisa, and JazzCash.</li> 
<li>After receiving the cash, the technician will pay the agreed-upon due service charges to Mahir Company.</li> 
<li>If the customer transfers the payable to the technician through online means, the technician will transfer Company's service charges the same day.</li> 
<li>In the event of an extension of any service, both technician and customer should inform Mahir Company, or else company will not take responsibility for any mishap, damage, or repair.</li> 
<li>Our verified technicians will adhere to the customers' specific needs in a manner specified in the technician-company contract.</li> 
<li>Both technician and customer will provide their reviews about the service after its completion.
            ...
            <div class="content">
    <h1>Role & Obligations of Mahir Company</h1>
        <ul>
        <li>Company connects customers with technicians for offering convenience to the first and employment opportunities to the latter.</li>
    <li>The age of a technician registering with us should be more than 18 years.</li>
    <li>The user of our service can either be a company or an individual.</li>
    <li>Account creation and booking of orders on Company are completely free of cost.</li>
    <li>At its will, Company may deny allowing any individual the creation or registration of an account with Company or suspend or cancel any existing account.</li>
    <li>Company takes no responsibility for any aspect of the technician and customer interaction (performance, delivery, description of Services, etc.)</li>
    <li>We do legal background checks of the technicians during the registration process but do not take any responsibility for wrongdoing by them at the site. In case of any theft or damage (intentional or unintentional), we can only provide you with information about the technician. We would not be able to support you any further if you want to go for legal proceedings.</li>
    <li>Company has no responsibility to any customer to support or involve itself in disagreement among Company’s platform users expect for enhancing user experience.</li>
    </ul>
    </div>
    ...
    <div class="content">
        ...
        <ul>
            <li>By agreeing to these conditions, you will all time:</li>
            <li>obey this Contract and all applicable regulations and laws.</li>
            <li>post the only correct information on the Mahir Company Platform.</li>
            <li>quickly and competently perform duties to the other user under the Contract.</li>
            <li>guarantee that You are mindful of all regulations that apply to You as a technician or a customer.</li>
            <li>Agree that any content (provided by the company, a customer, or Technician) on the Mahir Company Platform may not be utilized for other business purposes or on third party sites without asking permission from Mahir Company’s.</li>
            <li>You must not use the Mahir Company Platform for any immoral or illegal or activity.</li>
            <li>You must maintain your Mahir Company account by yourself and not sell or transfer your Account, or allow others to use it. You must also know that selling or transferring your Account's contents to a third part is also prohibited.</li>
            <li>You agree that any information posted on the Mahir Company Platform should not be actually or potentially damaging to Mahir Company or any other individual. Damages include, but are not limited to, financial loss that may or will be suffered by Mahir Company.</li>
            <li>Technicians must deliver Services to the customer in accordance with the Contract, except if the Services are forbidden by law.</li>
            <li>Technician must not charge a customer any additional fees on top of the advertised fee. Although, the parties to a Contract may decide to adjust the Agreed Price through the Mahir Company Platform.</li>
            <li>It is suggested not to demand payments separate from the Mahir Company Platform from the customer. This is suggested for the safety of your payment.</li>
            <li>If the customer agrees to reimburse any additional amount spent on equipment needed for the process, it will be the your (Technician's) sole responsibility to get the money from him. Mahir Company will not be a part of this aspect of the service delivery.</li>
        </ul>
    </div>
    ...
    <div class="content">
        <h1>Fees</h1>
        <ul>
            <li>Upon agreeing to the Contract, the Technician owes Mahir Company the Service Fee, which will be cut from the Decided Fee held in the Account.</li>
            <li>If the assigned task is enhanced or extended, the increased fee will not be added to the agreed Fees.</li>
            <li>All charges and fees payable to Mahir Company are non-refundable and non-cancellable (subject to the right of Non-Excludable Conditions).</li>
            <li> Until all Fees are paid, Mahir Company may restrict any User account.</li>
            <li>Customer will pay only service charges online and for material he/she will be paying the professional providing the service or the shop keeper.</li>
        </ul>
    </div>
    ...
    <div class="content">
        <h1>Return Policy</h1>
        <ul>
            <li>It will only be applicable on the service charges and not the material bought for the service.</li>
            <li>Our partner (vendor/beautician) will be liable to return the charges and the company will not be.</li>
            <li>It will be only valid for the service provided. For instance, if AC’s indoor was serviced and the problem arises in the outdoor, it will not be applicable.</li>
            <li>The return service amount will be transferred to the customers’ digital wallet.</li>
            <li>If the customer transferred the charges online, the bank will not be responsible for returning money instead it will be added to his/her digital wallet.</li>
        </ul>
    </div>
    ...
    <div class="content">
        <h1>Guarantee</h1>
        <ul>
            <li>You can avail of the guarantee period of 15 days on services provided by Mahir Company.</li>
            <li>If a customer claims a re-service after the guarantee period, his/her complaint will not be entertained until service charges are paid again.</li>
        </ul>
    </div>

    <div class="content">
        <h1>Cases in which 15 Days guarantee is not valid:</h1>
        <ul>
            <li>Home appliances repair & installation</li>
            <li>Short Circuits (electrician services)</li>
        </ul>
    </div>
    ...
    <div class="content">
        <ul>
            ...
            <li>If the Cancellation inform before the vender assignment in case of advanced payment we refund the full payment</li>
            <li>Customer should inform before the arrival time otherwise we charged 50rs on every Cancellation.</li>
        </ul>
    </div>

    <div class="content">
        <h1>Vendor Arrival Time</h1>
        <ul>
            <li>Customer schedule time is vender arrival time, in every task vender arrival time is with I hour margin</li>
        </ul>
    </div>
    ...
    <div class="content">
        ...
        <ul>
            <li>Mahir partner arrived on the task location in hour from booking time.</li>
        </ul>
    </div>
    ...
    <div class="content">
        <h1>Address</h1>
        <ul>
            <li>26-A, J 3 Block Block J 3 Phase 2 Johar Town, Lahore, Punjab 54000</li>
        </ul>
    </div>

    <div class="content">
        <h1>Maintained by Mahir</h1>
        <ul>
            <li>The following terms and conditions apply to all services provided by Maintained by Mahir. These must be read and accepted by all the subscribers:</li>
        </ul>
    </div>
    ...
    <div class="content">
        <h1>Packages</h1>
        <p>
            3 Marla, 5 Marla, 10 Marla, 1 Kanal, and 2 Kanal monthly plans are offered for subscription. Upon subscription, the Customer will get all the services and free services included in the packages. After the initial payment is received, the maintenance services shall begin on the date listed on the Agreement, which will continue as long as the Customer pays on time. The Customer will be alerted of the non-payment if it occurs. If the Customers will not respond to the alert and solve it, the Package(s) will be suspended at the end of the term. The Terms and Conditions hereunder are automatically renewed upon receipt of payment from the Customer for the outstanding amount.<b>Any cancellations made during the Term will not be refunded.</b>
        </p>
    </div>

    <div class="content">
        <h1>Non-Covered Repair Quotation:</h1>
        <ul>The company’s inspection and fixing offers are mentioned in packages. The Company shall not cover the replacement/installation of parts that are subject to natural wear and tear.</ul>
        <ul>Additional services, if required, shall be charged separately based on the time and material.</ul>
        <ul>The company only provides daywork service from 9 a.m. to 8 p.m. However, in addition to the contract cost, extra charges should be paid for emergency late-night bookings.</ul>
    </div>

    <div class="content">
        <h1>Procedure</h1>
        <ul>Step 1: Open Mahir App and go to the Maintained by Mahir tab.</ul>
        <ul>Step 2: Choose your subscription plan.</ul>
        <ul>Step 3: Enter your payment method.</ul>
        <ul>Step 4: Schedule your visit.</ul>
        <ul>Step 5: Your subscription is successfully done.</ul>
    </div>

    <div class="content">
        <h1>Rules for the Maintenance Inspection(s):</h1>
        <p>
    ...
    <div class="content">
        <h1>Cancellation:</h1>
        <ul>
            <li>You can cancel your order 24 hours before the time of the appointment. After this, the request for the cancellation of an order will not be processed.</li>
            <li>The appointment shall be canceled if you do not provide us with the required information for the processing of your requested service.</li>
            <li>In case there is no one at the given address to get the services done, and you do not respond to our attempts to connect to reschedule a visit with you, your order shall be canceled.</li>
            <li>Order will be canceled if the delivery of the required equipment and supplies to the given address has failed.</li>
            <li> You can reach out to us through email, social media, live chat, or the given contact number to request the cancellation of the order.</li>
            </ul>

    </div>
    <div class="content">
        <h1>Liability Of Losses:</h1>
        <ul>During the visit by Mahir Company’s staff, the property owner or any of his/her representatives should be present. Under the supervision of this representative, all work should be completed.</ul>
        <ul>If it is found that the owner's property has been damaged, mishandled, or stolen, Mahir and its partners shall conduct a detailed investigation. If no proof can be found during this investigation that could be traced to the company's representative at work, the company will not be held liable. The property owners are urged to be present at the time-of-service delivery and safeguard their important assets and belongings while the representative is on the site.</ul>
        <ul>If our representative recommends replacing any equipment, machine, or motor and the customer declines, the firm will not be responsible for any damage caused by the existing equipment, motor, or machine.</ul>
        <ul>If the property's air conditioning, electrical, and plumbing systems have been neglected, Mahir and his staff will give a plan for immediate corrective maintenance before beginning the Monthly Maintenance Contract. These expenses will be invoiced separately and are not covered by the monthly agreed price.</ul>
        <ul>The company will not be liable for any damage or defect discovered after the contract has expired.</ul>
    </div>

    <div class="content">
        <h1>Variation of Terms</h1>
        <p>
            Mahir Company is permitted to revise these terms at any time as it sees fit, and by using this Website you are expected to review these Terms regularly.
        </p>
    </div>
</main>
<?php
