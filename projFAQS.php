...
<body>
    ...
    <div class="container2">
        <div class="bannercontent">
            <h1 style="color: #f0f0f0; font-family:Poppins, sans-serif;font: size 2rem">FAQS</h1>
        </div>
    </div>
    </div>
    </div>
        <h1 style="font-size: 2rem;margin-bottom: .5rem;
        font-weight: 540;font-family: Poppins, sans-serif;margin-left: 20px">Faqs</h1>
        <div style="margin-left: 15px" class="accordians">
            <div  class="accordian-item">
            <div class="acrd-header d-flex flex-nowrap align-items-center">
        <p><strong style="font-family:Poppins, sans-serif; font-weight: bolder;font-size: 17px">How can I schedule an appointment with a professional technician from Mahir Company?</strong></p>
        </div>
        <div class="acrd-body" style="display: none;">
        <p>To book our professional services at Mahir Company, you have four convenient options: through our website's live chat, our dedicated mobile app, through the website, or via WhatsApp where you can either leave a message or directly call us.</p>
        </div>
        </div>
        ...
        <div class="accordian-item">
        <div class="acrd-header d-flex flex-nowrap align-items-center">
        <p><strong style="font-family:Poppins, sans-serif; font-weight: bolder;font-size: 17px;">What are the benefits of booking a service through the Mahir Company Mobile App?</strong></p>
        </div>
        <div class="acrd-body">
        <p>Booking through the Mahir Company Mobile App offers several advantages, including faster, safer, and more reliable service delivery. Additionally, when you download the Mahir Company app, you'll get Rs.100 in your wallet.</p>
        </div>
        </div>
        ...
        <div class="accordian-item">
        <div class="acrd-header d-flex flex-nowrap align-items-center">
        <p><strong style="font-family:Poppins, sans-serif; font-weight: bolder;font-size: 17px;">How do I register a complaint with Mahir Company?</strong></p>
        </div>
        <div class="acrd-body">
        <p>At Mahir Company, customer satisfaction is our priority. To ensure that we address any concerns you may have, we encourage customers to provide reviews. You can register a complaint by using our complaint box, engaging in live chat, reaching out to us on WhatsApp, or calling our customer service team directly.</p>
        </div>
        </div>
        ...
        <div class="accordian-item">
        <div class="acrd-header d-flex flex-nowrap align-items-center">
        <p><strong style="font-family:Poppins, sans-serif; font-weight: bolder;font-size: 17px;">How will I stay informed about new discount offers from Mahir Company?</strong></p>
        </div>
        <div class="acrd-body">
        <p>To stay updated on our latest offers and discounts, you can follow us on our social media platforms, including Facebook, Twitter, Instagram, and LinkedIn.</p>
        </div>
        </div>
        ...
        <div class="accordian-item">
        <div class="acrd-header d-flex flex-nowrap align-items-center">
        <p><strong style="font-family:Poppins, sans-serif; font-weight: bolder;font-size: 17px;">What sets Mahir Company apart as the best home maintenance services company in Pakistan?</strong></p>
        </div>
        <div class="acrd-body">
        <p>Mahir Company has earned its reputation as the premier home maintenance service provider in Pakistan due to our unwavering commitment to customer satisfaction. We pride ourselves on offering efficient, reliable, safe, and affordable services, delivered by well-trained and verified technicians. Our responsive customer service further reinforces our reputation as a reliable and trustworthy company for booking home maintenance services.</p>
        </div>
        </div>
        ...
        <div class="accordian-item">
        <div class="acrd-header d-flex flex-nowrap align-items-center">
        <p><strong style="font-family:Poppins, sans-serif; font-weight: bolder;font-size: 17px;">In which cities can I avail Mahir Company services?</strong></p>
        </div>
        <div class="acrd-body">
        <p>You can book expert and professional home maintenance services from Mahir Company in Lahore, Karachi, Islamabad, and Rawalpindi. Some of our cleaning, beauty &amp; personal care services are available in some of the mentioned cities, along with Lahore. While our newly launched vertical (Maintained by Mahir) and our new services (Solar Installation, Deep Cleaning, Inspection, and Solar Panel Cleaning Services) are only available in Lahore.</p>
        </div>
        </div>
        ...
        <div class="accordian-item">
        <div class="acrd-header d-flex flex-nowrap align-items-center">
        <p><strong style="font-family:Poppins, sans-serif; font-weight: bolder;font-size: 17px;">What new services will Mahir Company offer in the future?</strong></p>
        </div>
        <div class="acrd-body">
        <p>As part of our commitment to making home maintenance, cleaning, beauty &amp; personal care, Maintained by Mahir, Solar Installation, Deep Cleaning, Inspection, and Solar Panel Cleaning Services easy for our customers, we will soon make all the services available in Karachi, Rawalpindi, Islamabad, and other cities of Pakistan as those are in Lahore.</p>
        </div>
        </div>
        ...
        <div class="accordian-item">
        <div class="acrd-header d-flex flex-nowrap align-items-center">
        <p><strong style="font-family:Poppins, sans-serif; font-weight: bolder;font-size: 17px;">What are the service booking timings?</strong></p>
        </div>
        <div class="acrd-body">
        <p>To cater to your convenience, you can book our services from 9 am to 9 pm throughout the week, including weekends.</p>
        </div>
        </div>
        ...
        <div class="accordian-item">
        <div class="acrd-header d-flex flex-nowrap align-items-center">
        <p><strong style="font-family:Poppins, sans-serif; font-weight: bolder;font-size: 17px;">How can I address any issues, charges, or seek guidance?</strong></p>
        </div>
        <div class="acrd-body">
        <p>If you encounter any issues during your service experience, have questions about charges, or need guidance, you can call our customer service representative. They will be happy to assist you and provide clarifications. You can also call us at <a href="tel:+923096661919">0309 6661919</a> for any billing-related queries after checking through our mobile app.</p>
        </div>
        </div>
        ...
        <div class="accordian-item">
        <div class="acrd-header d-flex flex-nowrap align-items-center">
        <p><strong style="font-family:Poppins, sans-serif; font-weight: bolder;font-size: 17px;">What are the Inspection charges at Mahir Company?</strong></p>
        </div>
        <div class="acrd-body">
        <p>Our inspection charges are only Rs.500.</p>
        </div>
        </div>
        ...
        <div class="accordian-item">
        <div class="acrd-header d-flex flex-nowrap align-items-center">
        <p><strong style="font-family:Poppins, sans-serif; font-weight: bolder;font-size: 17px;">Can I cancel my booking?</strong></p>
        </div>
        <div class="acrd-body">
        <p>Yes, you have the option to cancel your bookings at any stage of the order and book again at your convenience.</p>
        </div>
        </div>
</div>
<?php
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    accordianItems.forEach(item => {
        const header = item.querySelector(".acrd-header");
        const body = item.querySelector(".acrd-body");
